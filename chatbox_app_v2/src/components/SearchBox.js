...
const SearchBox = () => {
  ...
  return (
    <div className="w-[700px] overflow-y-auto shrink-0 flex flex-col items-center justify-start py-[30px] px-2.5 box-border gap-[20px] max-w-full text-left text-sm text-neutral-60 font-text-l-medium mq1100:pt-5 mq1100:pb-5 mq1100:box-border">
      <img
        ...
        src="/guzo-1-1@2x.png"
      />
      <h1 className="m-0 w-[578px] h-11 relative text-17xl leading-[44px] font-semibold font-inherit text-black inline-block max-w-full mq750:text-10xl mq750:leading-[35px] mq1025:text-3xl mq1025:leading-[26px]">
        Welcome back, Impact Hub Team
      </h1>
      <div className="w-[600px] rounded-3xl bg-neutral-10 box-border flex flex-row flex-wrap items-center justify-start py-2 pr-[17px] pl-[15px] gap-[8px] max-w-full border-[1px] border-solid border-neutral-50 mq450:w-[calc(100%_-_40px)]">
        ...
        <button
          className="cursor-pointer [border:none] py-2 px-5 bg-adventure-blue-adventure-blue-500 h-9 rounded-3xl flex flex-row items-center justify-center box-border gap-[4px]"
      ...
      <div className="w-[640px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full text-dimgray">
        <div className="flex-1 rounded-3xs bg-energy-red-energy-red-50 box-border overflow-hidden flex flex-col items-center justify-start py-5 px-[19px] max-w-full border-[1px] border-solid border-power-black-power-black-100">
          ...
          <div className="self-stretch rounded-3xl bg-energy-red-energy-red-50 flex flex-row items-center justify-center py-2 px-4 box-border max-w-full">
            <input
              className="[border:none] [outline:none] font-medium font-text-l-medium text-sm bg-[transparent] h-5 flex-1 relative leading-[20px] text-dimgray text-left inline-block min-w-[250px] max-w-full"
      ...
      <div className="self-stretch flex flex-row items-center justify-between gap-[20px] text-center text-xl text-black-text mq1025:flex-wrap mq1025:justify-center">
        <div className="flex flex-row items-start justify-start">
          <div className="h-7 w-[139px] relative tracking-[-0.02em] leading-[28px] font-semibold inline-block mq1025:text-base mq1025:leading-[22px]">
            Search History
          </div>
        </div>
        <div
          className="h-9 rounded-lg flex flex-row items-center justify-center py-2 px-[18px] box-border gap-[4px] cursor-pointer text-left text-base text-adventure-blue-adventure-blue-500"
      ...
      <div
        className="w-[600px] rounded-3xl bg-adventure-blue-adventure-blue-50 box-border flex flex-row flex-wrap items-center justify-start py-2 pr-[17px] pl-[15px] gap-[8px] max-w-full cursor-pointer border-[1px] border-solid border-neutral-50 mq450:w-[calc(100%_-_40px)]"
      ...
      >
        ...
        <input
          className="[border:none] [outline:none] bg-[transparent] h-9 w-[102px] rounded-lg flex flex-row items-center justify-center py-2 px-5 box-border font-text-l-medium font-medium text-base text-adventure-blue-adventure-blue-500"
          placeholder="Remove"
          type="text"
          value={button1Value}
      ...
      <div className="w-[600px] rounded-3xl bg-adventure-blue-adventure-blue-50 box-border flex flex-row flex-wrap items-center justify-start py-2 pr-[17px] pl-[15px] gap-[8px] max-w-full border-[1px] border-solid border-neutral-50 mq450:w-[calc(100%_-_40px)]">
      ...
      <div className="rounded-3xl bg-adventure-blue-adventure-blue-50 box-border flex flex-row items-center justify-start py-2 pr-[17px] pl-[15px] gap-[8px] max-w-full border-[1px] border-solid border-neutral-50 mq450:flex-wrap mq450:w-[calc(100%_-_40px)]">
