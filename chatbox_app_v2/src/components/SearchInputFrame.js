...
const SearchInputFrame = () => {
  ...
  return (
    <div className="w-[700px] overflow-y-auto shrink-0 flex flex-col items-center justify-start py-[30px] px-2.5 box-border gap-[20px] min-h-[1024px] max-w-full text-left text-sm text-neutral-60 font-text-l-medium mq450:pt-5 mq450:pb-5 mq450:box-border mq750:min-h-[auto]">
      <img
        ...
        src="/guzo-1-1@2x.png"
      />
      <h1 className="m-0 w-[258px] h-11 relative text-17xl leading-[44px] font-semibold font-inherit text-black inline-block mq1025:text-3xl mq1025:leading-[26px] mq1100:text-10xl mq1100:leading-[35px]">
        Search History
      </h1>
      ...
      <div className="rounded-3xl bg-adventure-blue-adventure-blue-50 box-border flex flex-row items-center justify-start py-2 pr-[17px] pl-[15px] gap-[8px] max-w-full border-[1px] border-solid border-neutral-50 mq450:flex-wrap">
      ...
      <div className="w-[600px] rounded-3xl bg-adventure-blue-adventure-blue-50 box-border flex flex-row items-center justify-start py-2 pr-[17px] pl-[15px] gap-[8px] max-w-full border-[1px] border-solid border-neutral-50 mq450:flex-wrap">
