...
const ContactInfoPopout = ({ onClose }) => {
  ...
  return (
    <div className="w-[800px] h-[970px] rounded-3xs bg-neutral-10 overflow-y-auto flex flex-col items-center justify-start py-[25px] px-0 box-border gap-[30px] tracking-[normal] max-w-full max-h-full overflow-auto mq725:h-auto">
      <main className="self-stretch flex flex-col items-start justify-start py-0 px-[30px] box-border max-w-full shrink-0">
        <section className="self-stretch flex flex-col items-start justify-start max-w-full text-left text-xl text-black font-text-m-medium">
          <header className="self-stretch flex flex-row items-start justify-start max-w-full text-left text-xl text-black font-text-m-medium">
            <div className="flex-1 flex flex-col items-start justify-center max-w-full">
              <div className="flex flex-col items-start justify-start">
                <div className="flex flex-row items-center justify-center">
                  <h3 className="m-0 h-7 w-[175px] relative text-inherit tracking-[-0.02em] leading-[28px] font-semibold font-inherit inline-block whitespace-nowrap">
                    Guzo Contact Info
                  </h3>
                </div>
              </div>
          ...
          <div className="self-stretch flex flex-col items-center justify-start max-w-full">
            ...
            <div className="self-stretch flex flex-row items-start justify-center max-w-full">
              <div className="flex-1 flex flex-col items-center justify-start max-w-full">
                <div className="flex flex-col items-start justify-start">
                  <div className="flex flex-row items-center justify-center">
                    <h3 className="m-0 h-7 w-[50px] relative text-inherit tracking-[-0.02em] leading-[28px] font-semibold font-inherit inline-block mq725:text-base mq725:leading-[22px]">
                      Guzo
                    </h3>
                  </div>
                </div>
          ...
          <div className="self-stretch bg-neutral-10 flex flex-col items-start justify-start p-5 box-border gap-[20px] max-w-full">
            <div className="self-stretch flex flex-row items-start justify-start max-w-full">
              <div className="flex-1 flex flex-col items-start justify-center max-w-full">
                <div className="flex flex-col items-start justify-start">
                  <div className="flex flex-row items-center justify-center">
                    <h3 className="m-0 h-7 w-[166px] relative text-inherit tracking-[-0.02em] leading-[28px] font-semibold font-inherit inline-block mq725:text-base mq725:leading-[22px]">
                      Organization Info
                    </h3>
                  </div>
                </div>
            ...
            <form className="m-0 self-stretch flex flex-col items-start justify-start py-0 px-[30px] gap-[20px]">
              <div className="self-stretch flex flex-col items-start justify-start gap-[4px]">
                <div className="self-stretch h-5 relative text-sm tracking-[-0.01em] leading-[20px] font-medium font-text-m-medium text-neutral-90 text-left inline-block">
                  Website
                </div>
                ...
                <div className="self-stretch relative text-xs leading-[18px] font-text-m-medium text-neutral-60 text-left hidden" />
              </div>
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[20px]">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[4px]">
                  ...
                  <div className="self-stretch rounded-lg bg-neutral-10 box-border overflow-hidden flex flex-row items-center justify-between p-1.5 min-h-[96px] gap-[20px] border-[1px] border-solid border-power-black-power-black-50 mq725:flex-wrap">
                    <div className="h-10 w-52 relative text-sm tracking-[-0.01em] leading-[20px] font-medium font-text-m-medium text-power-black-power-black-500 text-left inline-block shrink-0">
                      <p className="m-0">777 Main St.</p>
                      <p className="m-0">Houston, TX 77002</p>
                    </div>
                    <button className="cursor-pointer [border:none] py-2 px-5 bg-adventure-blue-100 h-9 rounded-3xl flex flex-row items-center justify-center box-border gap-[4px]">
                      <img
                        className="h-4 w-4 relative overflow-hidden shrink-0 hidden"
                        alt=""
                        src="/solidemojihappy.svg"
                      />
                      <div className="h-6 w-[41px] relative text-base leading-[24px] font-medium font-text-m-medium text-neutral-neutral-100 text-left inline-block">
                        Copy
                      </div>
                      <img
                        className="h-4 w-4 relative overflow-hidden shrink-0 hidden"
            ...
            <div className="self-stretch flex flex-row items-start justify-start max-w-full">
              <div className="flex-1 flex flex-col items-start justify-center max-w-full">
                <div className="flex flex-col items-start justify-start">
                  <div className="flex flex-row items-center justify-center">
                    <h3 className="m-0 h-7 w-[97px] relative text-inherit tracking-[-0.02em] leading-[28px] font-semibold font-inherit inline-block mq725:text-base mq725:leading-[22px]">
                      The Team
                    </h3>
                  </div>
                </div>
            ...
            <div className="w-[480px] flex flex-row items-start justify-start gap-[20px] max-w-full text-xs text-neutral-60 mq725:flex-wrap">
              ...
              <div className="flex-1 rounded-3xs bg-neutral-10 flex flex-col items-center justify-start py-[15px] px-5 gap-[30px] border-[1px] border-solid border-power-black-power-black-50">
                <div className="self-stretch flex flex-col items-center justify-start gap-[10px] text-sm text-black">
                  <img
                    ...
                    loading="lazy"
                    alt=""
                    src="/persona-image-11@2x.png"
                  />
                  <div className="self-stretch flex flex-col items-center justify-start">
                    <div className="self-stretch flex flex-row items-center justify-center">
                      <div className="h-5 w-[103px] relative leading-[20px] font-semibold inline-block">
                        Rishi Prasadha
                      </div>
                    </div>
                  </div>
      ...
      <footer className="self-stretch flex flex-row items-start justify-center pt-0 px-[30px] pb-[60px] text-left text-base text-adventure-blue-100 font-text-m-medium">
        <div
          className="h-9 w-[171px] rounded-3xl bg-adventure-blue-adventure-blue-50 flex flex-row items-center justify-center py-2 px-5 box-border gap-[4px] cursor-pointer"
