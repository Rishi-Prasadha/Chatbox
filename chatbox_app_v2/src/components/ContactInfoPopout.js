...
const ContactInfoPopout = ({ onClose }) => {
  ...
  return (
    <div className="w-[800px] h-[970px] rounded-3xs bg-neutral-10 overflow-y-auto flex flex-col items-center justify-start py-[25px] px-0 box-border gap-[30px] tracking-[normal] max-w-full max-h-full overflow-auto mq450:h-auto">
          ...
          <div className="self-stretch bg-neutral-10 flex flex-col items-start justify-start p-5 box-border gap-[20px] max-w-full">
            <div className="self-stretch flex flex-row items-start justify-start max-w-full">
              <div className="flex-1 flex flex-col items-start justify-center max-w-full">
                <div className="flex flex-col items-start justify-start">
                  <div className="flex flex-row items-center justify-center">
                    <h3 className="m-0 h-7 w-[166px] relative text-inherit tracking-[-0.02em] leading-[28px] font-semibold font-inherit inline-block mq450:text-base mq450:leading-[22px]">
                      Organization Info
                    </h3>
                  </div>
                </div>
            ...
            <form className="m-0 self-stretch flex flex-col items-start justify-start py-0 px-[30px] gap-[20px]">
              <div className="self-stretch flex flex-col items-start justify-start gap-[4px]">
                ...
                <div className="self-stretch rounded-lg bg-neutral-10 overflow-hidden flex flex-row items-center justify-start p-1.5 border-[1px] border-solid border-power-black-power-black-50">
                  <input
                    className="[border:none] [outline:none] font-medium font-text-l-medium text-sm bg-[transparent] h-5 w-52 relative tracking-[-0.01em] leading-[20px] text-power-black-power-black-500 text-left inline-block shrink-0"
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[20px]">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[4px]">
                  ...
                  <div className="self-stretch rounded-lg bg-neutral-10 overflow-hidden flex flex-row items-center justify-start p-1.5 border-[1px] border-solid border-power-black-power-black-50">
                    <input
                      className="[border:none] [outline:none] font-medium font-text-l-medium text-sm bg-[transparent] h-5 w-52 relative tracking-[-0.01em] leading-[20px] text-left inline-block shrink-0"
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[20px]">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[4px]">
                  ...
                  <div className="self-stretch rounded-lg bg-neutral-10 box-border overflow-hidden flex flex-row items-center justify-between p-1.5 min-h-[96px] gap-[20px] border-[1px] border-solid border-power-black-power-black-50 mq450:flex-wrap">
                    ...
                    <button className="cursor-pointer [border:none] py-2 px-5 bg-adventure-blue-adventure-blue-500 h-9 rounded-3xl flex flex-row items-center justify-center box-border gap-[4px]">
                      <img
            ...
            <div className="self-stretch flex flex-row items-start justify-start max-w-full">
              <div className="flex-1 flex flex-col items-start justify-center max-w-full">
                <div className="flex flex-col items-start justify-start">
                  <div className="flex flex-row items-center justify-center">
                    <h3 className="m-0 h-7 w-[97px] relative text-inherit tracking-[-0.02em] leading-[28px] font-semibold font-inherit inline-block mq450:text-base mq450:leading-[22px]">
                      The Team
                    </h3>
                  </div>
                </div>
