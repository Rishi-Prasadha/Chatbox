...
const ContactInfoPopout1 = () => {
  ...
  const [wwwlinkedincominguzoTextValue, setWwwlinkedincominguzoTextValue] =
    useState("");
  return (
    <section className="w-[800px] h-[908px] rounded-3xs bg-neutral-10 overflow-y-auto shrink-0 flex flex-col items-center justify-start pt-[25px] px-0 pb-0 box-border gap-[20px] max-w-full text-left text-xl text-black font-text-l-medium">
          ...
          <div className="flex-1 flex flex-col items-start justify-center max-w-full">
            <div className="flex flex-col items-start justify-start">
              <div className="flex flex-row items-center justify-center">
                <h3 className="m-0 h-7 w-[61px] relative text-inherit tracking-[-0.02em] leading-[28px] font-semibold font-inherit inline-block mq750:text-base mq750:leading-[22px]">
                  Profile
                </h3>
              </div>
            </div>
        ...
        <div className="w-[700px] flex flex-col items-center justify-start pt-0 px-0 pb-5 box-border gap-[20px] max-w-full text-center text-xs">
          ...
          <div className="self-stretch flex flex-row items-start justify-start max-w-full text-left text-xl">
            <div className="flex-1 flex flex-col items-start justify-center max-w-full">
              <div className="flex flex-col items-start justify-start">
                <div className="flex flex-row items-center justify-center">
                  <h3 className="m-0 h-7 w-[166px] relative text-inherit tracking-[-0.02em] leading-[28px] font-semibold font-inherit inline-block mq750:text-base mq750:leading-[22px]">
                    Organization Info
                  </h3>
                </div>
              </div>
        ...
        <div className="w-[700px] flex flex-row items-start justify-start pt-0 px-0 pb-5 box-border max-w-full">
          <div className="flex-1 flex flex-row items-start justify-start max-w-full">
            <div className="flex-1 flex flex-col items-start justify-center max-w-full">
              <div className="flex flex-col items-start justify-start">
                <div className="flex flex-row items-center justify-center">
                  <h3 className="m-0 h-7 w-[97px] relative text-inherit tracking-[-0.02em] leading-[28px] font-semibold font-inherit inline-block mq750:text-base mq750:leading-[22px]">
                    The Team
                  </h3>
                </div>
              </div>
      ...
      <NameAreaInput
        ...
        propHeight2="20px"
      />
      <div className="mt-[-1291px] mb-[-1291px] w-[148px] h-10 rounded-3xl bg-adventure-blue-adventure-blue-50 shrink-0 flex flex-row items-center justify-center p-2 box-border gap-[4px] text-base text-adventure-blue-adventure-blue-500">
        <img
