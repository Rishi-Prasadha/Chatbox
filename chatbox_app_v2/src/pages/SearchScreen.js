...
const SearchScreen = () => {
  ...
  return (
    <div className="w-full relative bg-neutral-10 flex flex-row items-start justify-start tracking-[normal] mq450:pl-5 mq450:pr-5 mq450:box-border">
      ...
      />
      <main className="flex-1 bg-whitesmoke-200 overflow-y-auto flex flex-col items-start justify-start pt-0 px-[60px] pb-[30px] box-border gap-[30px] max-w-[calc(100%_-_114px)] text-left text-sm text-neutral-60 font-text-m-medium mq975:gap-[15px] mq450:max-w-full mq1000:pl-[30px] mq1000:pr-[30px] mq1000:box-border">
        <section className="w-[846px] flex flex-row flex-wrap items-start justify-start gap-[48px] max-w-full mq725:gap-[24px]">
          <FrameContainer
        ...
        <div className="w-[980px] flex flex-row items-start justify-center max-w-full">
          <div className="w-[600px] rounded-3xl bg-neutral-10 box-border flex flex-row flex-wrap items-center justify-start py-2 pr-[17px] pl-[15px] gap-[8px] max-w-full border-[1px] border-solid border-neutral-50">
            ...
            <div className="h-9 rounded-3xl bg-adventure-blue-100 flex flex-row items-center justify-start py-1.5 px-5 box-border gap-[4px] text-base text-neutral-neutral-100">
              <img
